...
1. If you have a thermometer or other way of measuring the temperature inside of your room, record the value. Otherwise, assume that it is about $20^{\circ}$C inside. Then determine the speed of sound in your room.
...
::: Question
a) What is the uncertainty in your resonant length measurement?

b) Is it larger, smaller, or the same as that for a direct measurement of the tube?
...
3. Take the slope of the line, and use your answer to Question $1$ to determine the speed of sound.
...
In order to find the error in the speed of sound that arises from the error in the slope, $v_s$ use the following equation: 
