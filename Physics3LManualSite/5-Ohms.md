...
Use [Si](#Si-resistivity) to verify your result.
...
In this exercise we will examine the circuit shown in [Fi](#Fi-oneResistor) and built in [Vi](#Vi-1Rconstruct) (below). [Fi](#Fi-oneResistor) shows the schematic representation of the circuit, which consists of a power supply and a resistor. We will use a voltmeter and an ammeter to measure, respectively, the voltage across, and the current passing through, a resistor.

1. Examine the circuit shown in [Fi](#Fi-oneResistor). A resistor of resistance **R** $=2,200\ \Omega$ is wired in series with an ammeter and connected to the 0–20-volt power supply. The ammeter will measure the current (mA) flowing through the circuit. The voltmeter is connected across the resistor to measure the voltage drop.

:::Figure oneResistor
![Figure 1: A circuit with a single resistor of resistance **R**.](../imgs/lab5/Figure1_Part1Circuit.jpg)
:::

[Vi](#Vi-1Rconstruct) shows the construction of the circuit in [Fi](#Fi-oneResistor).

<!-- Video 2 -->

:::Video 1Rconstruct
<iframe width="100%" height="800" src="https://www.youtube.com/embed/6uP-mirlYSo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
:::
...
:::Video 1RvoltageSweep
<iframe width="100%" height="800" src="https://www.youtube.com/embed/y6ZEXgQUqes" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
:::

[Vi](#Vi-1RvoltageSweep) shows the circuit from [Fi](#Fi-oneResistor) and [Vi](#Vi-1RConstruct), with the voltage from the power supply being slowly changed from 0 volts to 20 volts.
...
In this exercise you will use the technique from Exercise 2 to find the value of an unknown resistor. [Vi](#Vi-seriesR) will show the circuit being set up, and then a scan of the voltage from 0 to 20 volts. The circuit layout will be identical to that in [Fi](#Fi-oneResistor).
...
:::
1. Watch [Vi](#Vi-seriesR). As the  voltage changes, pause the video, and record the voltage and corresponding current for 10 data points. You should take measurements approximately every 2 volts. They do not, however, need to be exactly 2 volts apart, as long as the data points are fairly well spaced out.
...
![Figure 4: Ciruit Question](../imgs/lab5/Figure4_Part3CircuitQ.jpg)
::: -->
...
[Fi](#Fi-seriesR), in the next exercise, shows a circuit with two resistors connected in series.

:::::: Exercise
1. Examine the circuit shown in [Fi](#Fi-seriesR). Two resistors of resistance **R** $=2,200\ \Omega$ are wired in series with an ammeter and connected to the 0–20-volt power supply. The ammeter will measure the current (mA) flowing through the circuit. The voltmeter is connected across the two resistors to measure the total voltage drop across them.

:::Figure seriesR
![Figure 2: Two resistors of resistance **R** are wired in series.](../imgs/lab5/Figure2_Part2Circuit.jpg)
:::

<!-- Video 4: Two Series Resistors -->

:::Video seriesConstruct
<iframe width="100%" height="800" src="https://www.youtube.com/embed/6Kj52kXYTyw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
:::

[Vi](#Vi-seriesR) shows the circuit in [Fi](#Fi-seriesR), with the voltage across the pair of resistors being changed slowly from 0 to 20 volts.
...
2. Watch [Vi](#Vi-seriesR). For this exercise, we have taken the data, which we will provide to you.  You should watch the video, however, to see how the current changes with the applied voltage, as compared to the way it did in the last video.
<!--
...
You are now familiar with the relationships among current, voltage and resistance for a single resistor, and with the way resistors behave when you connect them in series. In a parallel configuration we have two or more elements connected to each other at both ends. [Fi](#Fi-parallelR3), in [Ex](#Ex-parallel), shows three resistors in a parallel configuration. Note that in circuits, any points connected by a wire are considered to be the same point. (That is, since they are connected by a wire, they are at the same potential.) Thus, for resistors in parallel, Ohm’s law applies to each resistor individually. Therefore, the current through each resistor is inversely proportional to its resistance. The total current flowing in the circuit is the sum of the currents flowing through the individual resistors.
...
:::::: Exercise parallel
1. Examine the circuit shown in [Fi](#Fi-parallelConstruct). Two resistors of resistance **R** $=2,200\ \Omega$, connected in parallel, are connected in series with the ammeter and the 0–20-volt power supply. The voltmeter is connected across the resistors to measure the voltage drop. The ammeter is in series with the circuit and measures total current in the circuit. 
...
:::Figure parallelConstruct
![Figure 3. Two resistors of resistance **R** in parallel.](../imgs/lab5/Figure3b_Part3Circuit.jpg)
:::

<!-- Video 6: Two in Parallel -->

:::Video parallelR
<iframe width="100%" height="800" src="https://www.youtube.com/embed/8JM-5cI3zhM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
:::

[Vi](#Vi-parallelR) shows the circuit in [Fi](#Fi-parallelConstruct), with the voltage across the pair of resistors being changed slowly from 0 to 20 volts. 
<!--
### Notice: You may pick a single voltage/current pair to find the resistance, instead of finding it for 10 pairs.
-->
2. Watch [Vi](#Vi-parallelR). As we did for the previous exercise, we will provide you with data that we took. You should watch the video to see how the current changes with the applied voltage, as compared to the way it did in the last two experiments.
...
4. Now Examine the circuit shown in [Fi](#Fi-parallelR3). Three resistors of resistance **R** $=2,200\ \Omega$, connected in parallel, are connected in series with the ammeter and the 0–20 volt power supply. The voltmeter is connected across the resistors to measure the voltage drop. The ammeter is in series with the circuit and measures total current in the circuit. There are now three paths for the current to take.

:::Figure parallelR3
![Figure 4. Three resistors of resistance **R** in parallel.](../imgs/lab5/Figure3c_Part3Circuit.jpg)
:::

<!-- Video 7: Three in Parallel -->

:::Video 3parallel
<iframe width="100%" height="800" src="https://www.youtube.com/embed/P-kIiMwo7s0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
:::

[Vi](#Vi-3parallel) shows the circuit in [Fi](#Fi-parallelR3), with the voltage across the set of three parallel resistors being changed slowly from 0 to 20 volts.. 
<!--
### Notice: You may pick a single voltage/current pair to find the resistance instead of finding 10 pairs.
-->
5. Watch [Vi](#Vi-3parallel). As we did for the previous two exercises, we will provide you with data that we took. You should watch the video to see how the current changes with the applied voltage, as compared to the way it did in the previous experiment.
<!--
...
[Vi](#Vi-simTutorial) is a brief overview of the simulation and how it works.

<!-- Video for using the DC PhET -->
:::Video simTutorial
<iframe width="100%" height="800" src="https://www.youtube.com/embed/nv3tOd_Q2Zg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
::: 

:::::: Exercise

In this exercise your objective is to build a circuit with a resistance of 1.5 kΩ. You have available, however, only 1 kΩ; resistors. You can accomplish this by using the equivalent resistance equations for both series and parallel, to arrange some of the 1 kΩ resistors so that their overall resistance equals 1.5 kΩ.

:::Simulation circuitBuilder
<iframe src="https://phet.colorado.edu/sims/html/circuit-construction-kit-dc-virtual-lab/latest/circuit-construction-kit-dc-virtual-lab_en.html" width="100%" height="800" scrolling="no" allowfullscreen></iframe>
:::

1. Familiarize yourself with [Si](#Si-circuitBuilder).

2. Use the equations for equivalent resistance of resistors both in series and in parallel, to design a circuit that contains only 1 kΩ resistors, but has an overall resistance of 1.5 kΩ.

::: Note
**Hint:** Start by thinking about what values the simplest resistor combinations would yield.
:::
3. Begin building your circuit in [Si](#Si-circuitBuilder) to test your design. Note that switches are helpful for quick testing of different parts of a circuit. 

::: Question
1. What is the least number of resistors you need to make your circuit work?

2. What is the configuration of this circuit? (You should include a screenshot of your circuit, but please describe it in words.)
:::
